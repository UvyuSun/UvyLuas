...
function user_setup()
    state.OffenseMode:options('Normal','UiA')
...
function init_gear_sets()
    ...
    hands="Volte Bracers",
    feet={ name="Herculean Boots", augments={'AGI+4','Accuracy+14','"Treasure Hunter"+2','Mag. Acc.+8 "Mag.Atk.Bns."+8',}},
    waist="Chaac Belt",})
    ...
    back={ name="Mecisto. Mantle", augments={'Cap. Point+49%','HP+18','"Mag.Atk.Bns."+4','DEF+2',}},
}
    sets.idle.Pet = {
    ammo="Automat. Oil +2",
    head="Pup. Taj",
